...
const { PdfReader } = require('pdf-text-reader'); // Ganti menggunakan library pembaca teks murni
    ...
    async getAllDocuments() {
        ...
        try {
            ...
            for (const blob of blobs) {
                ...
                // =========================================================================
                // JALUR 2: PROSES PEMBACAAN FILE PDF DARI CLOUD (FIXED UNTUK VERCEL)
                // =========================================================================
                else if (ext === '.pdf') {
                    try {
                        // Membaca isi halaman PDF langsung dari memory buffer cloud
                        const pages = await PdfReader.readPdfPages({ buffer: fileBuffer });
                        
                        // Ekstrak teks dari tiap halaman lalu satukan menjadi string utuh
