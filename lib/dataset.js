    ...
    async getAllDocuments() {
        ...
        try {
            ...
            for (const blob of blobs) {
                ...
                // =========================================================================
                // JALUR 2: PROSES PEMBACAAN FILE PDF DARI CLOUD (FIX SERVERLESS VERCEL)
                // =========================================================================
                else if (ext === '.pdf') {
                    try {
                        // SOLUSI: Menggunakan custom pagerender untuk mengekstrak teks mentah langsung 
                        // tanpa memanggil library rendering visual canvas yang memicu error DOMMatrix.
