class RAGEngine {
    ...
    retrieveContext(query, documents, topK = 6) {
        ...
        const scoredDocs = documents.map(doc => {
            ...
            // Jika ada lebih dari 1 kata kunci yang cocok dalam satu chunk teks PDF yang sama,
            // beri skor tambahan karena kemungkinan besar paragraf tersebut membahas topik yang dicari.
            ...
            // 4. BONUS SUMBER (Opsional, memberikan sedikit bobot pada nama file)
            queryWords.forEach(word => {
